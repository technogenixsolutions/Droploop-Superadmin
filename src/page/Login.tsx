...
// import { useLoginMutation } from '@/redux/slices/AuthenticationSlice';
...
function Login() {
  ...
  const formSchema = z.object({
    ...
    //   message: 'You must agree to the conditions',
    // }),
  });
      ...
      <div className="flex min-h-screen flex-1 flex-col justify-center">
        <div className="mx-auto w-2/3 rounded-lg p-8 pt-0">
          ...
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              {/* <div className="flex items-center justify-between">
                ...
                <a
                  href="http://"
                  className="italic text-gray-400 delay-200 duration-200 ease-in hover:text-gray-700"
                >
              ...
              <div className="flex justify-center space-x-4">
                ...
                {/* <Button
                className="w-full rounded-lg bg-gray-100 py-3 text-gray-700 hover:bg-gray-200"
                type="button"
                onClick={() =>
                  handleSocialLogin(
                    `${import.meta.env.VITE_BASEURL}/auth/facebook/redirect`,
                  )
                }
              >
                <FaFacebook size={18} />
          ...
          <p className="mt-5 text-center text-lg text-gray-400">
            ...
            <Link to={ROUTES.SIGN_UP} className="text-[#977af1]">
              Sign Up
            </Link>
          </p>
          {/* <a
